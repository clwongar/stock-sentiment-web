...
def start():
    ...
    #sentiment
    scheduler.add_job(dailyUpdate, trigger="cron", args=[1],day='*', hour=15, minute=50,id="stock_001", replace_existing=True)
    scheduler.add_job(dailyUpdate, trigger="cron", args=[2],day='*', hour=15, minute=52,id="stock_002", replace_existing=True)
    ...
    #lstm
    scheduler.add_job(dailyUpdate, trigger="cron", args=[7],day='*', hour=21, minute=56,id="stock_007", replace_existing=True)
